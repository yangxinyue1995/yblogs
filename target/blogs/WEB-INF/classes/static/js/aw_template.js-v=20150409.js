var AW_TEMPLATE = {
	...
	'editCommentBox' :
				...
				'<div class="modal-dialog">'+
					'<div class="modal-content">'+
						'<div class="modal-header">'+
							'<a type="button" class="close icon icon-delete" data-dismiss="modal" aria-hidden="true"></a>'+
							'<h3 class="modal-title" id="myModalLabel">' + _t('编辑评语') + '</h3>'+
						'</div>'+
			...
			'<div class="modal fade alert-box aw-publish-box">'+
				'<div class="modal-dialog">'+
					'<div class="modal-content">'+
						'<div class="modal-header">'+
							'<a type="button" class="close icon icon-delete" data-dismiss="modal" aria-hidden="true"></a>'+
							'<h3 class="modal-title" id="myModalLabel">' + _t('简易投稿') + '</h3>'+
						'</div>'+
						'<div class="modal-body">'+
							'<div class="alert alert-danger hide error_message"><i class="icon icon-delete"></i> <em></em></div>'+
							'<form action="' + G_BASE_URL + '/publish/ajax/publish_question/" method="post" id="quick_publish" onsubmit="return false">'+
								...
								'<div>'+
									'<textarea class="form-control" placeholder="' + _t('写下帖子标题') + '..." rows="1" name="question_content" id="quick_publish_question_content" onkeydown="if (event.keyCode == 13) { return false; }"></textarea>'+
					...
					'<div class="modal-content">'+
						...
						'<div class="modal-body">'+
							...
							'<form action="' + G_BASE_URL + '/question/ajax/save_answer_fox/" method="post" id="quick_publish" onsubmit="return false">'+
								'<input type="hidden" name="post_hash" value="' + G_POST_HASH + '" />'+
								'<input id="foxid" class="form-control" type="hidden" placeholder="' + _t('相关帖子不能为空') + '" name="foxid" value="{{foxid}}" />'+
								'<div class="aw-dropdown">'+
									'<p class="title">' + _t('没有找到相关结果') + '</p>'+
									'<ul class="aw-dropdown-list">'+
									'</ul>'+
			...
			'<div class="modal fade alert-box aw-inbox">'+
				'<div class="modal-dialog">'+
					'<div class="modal-content">'+
						'<div class="modal-header">'+
							'<a type="button" class="close icon icon-delete" data-dismiss="modal" aria-hidden="true"></a>'+
							'<h3 class="modal-title" id="myModalLabel">' + _t('帖子置顶') + '</h3>'+
						'</div>'+
						'<div class="modal-body">'+
							'<div class="alert alert-danger hide error_message"> <i class="icon icon-delete"></i> <em></em></div>'+
	...
	'searchDropdownListQuestions' :
		'<li class="{{active}} question clearfix"><i class="icon icon-bestbg pull-left"></i><a class="aw-hide-txt pull-left" href="{{url}}">{{content}} </a><span class="pull-right text-color-999">{{discuss_count}} ' + _t('条评论') + '</span></li>',
							...
							'<form id="login_form" method="post" onsubmit="return false" action="' + G_BASE_URL + '/account/ajax/login_process/">'+
								'<input type="hidden" name="return_url" value="{{return_url}}" />'+
									'<ul>'+
										...
										'</li>'+
									'</ul>'+
									'<p class="margin-top-sm"><a href="http://www.fanjianzhi.net/static/js/account/find_password/" target="_blank">忘记密码</a><a href="http://www.fanjianzhi.net/static/js/account/register/" class="pull-right" target="_blank">免费注册</a></p>'+
							'</form>'+
						'</div>'+
					'</div>'+
				'</div>'+
